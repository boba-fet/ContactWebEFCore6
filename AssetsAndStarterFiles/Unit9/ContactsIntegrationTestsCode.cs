    ...
    public class TestContactsData
    {
        ...
        public async Task AddAndDeleteContact()
        {
            using (var context = new MyContactManagerDbContext(_options))
            {
                ...
                var contactToAdd = new Contact() { Birthday = new DateTime(1971, 10, 12), City = "Somewhere", Email="jlpicard@starfleet.com", FirstName = "Jean-Luc"
                                , LastName = "Picard", PhonePrimary = "555-555-9999", PhoneSecondary = "555-555-9999", StateId= 4
                                , StreetAddress1 = "999 Fourth St", StreetAddress2 = "UNIT 99", UserId = USERID2, Zip="99999"  };
